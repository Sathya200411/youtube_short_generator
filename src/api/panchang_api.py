...
class PanchangAPI:
    def __init__(self):
        ...
        self.base_url = "https://api.prokerala.com/v2/astrology/panchang"

    def get_access_token(self):
        """Get access token using client credentials (correct endpoint)"""
    ...
    def get_panchang(self, datetime_str=None, latitude="19.0821978", longitude="72.7411014", 
        ...
        """
        Get panchang data from the API (GET request with query params)
        """
...
if __name__ == "__main__":
    api = PanchangAPI()
    result = api.get_panchang()
    print("Panchang API Result:")
